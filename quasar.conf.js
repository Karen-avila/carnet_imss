...
module.exports = function (/* ctx */) {
  return {
    ...
    build: {
      ...
      env: {
        AUTHENDPOINT: process.env.AUTHENDPOINT ? process.env.AUTHENDPOINT : 'https://msapop-autenticacion.cloudapps.imss.gob.mx', //'https://msapop-autenticacion.cloudapps.imss.gob.mx'
